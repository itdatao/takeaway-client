...
import com.ruoyi.web.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = Constants.FILE_PATH;
...
//        }
    ...
    private static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = Constants.FILE_PATH.length() + 1;
